...
public class ReadKml1 {
	...
	public static void main(String[] args) throws Exception {
		...
		// String
		//filePath = "C://Users//888//Desktop//王总GIS//地图文件//路基隧道线路中心线点文件.kml";// mark
		// String 
		...
		//String	filePath="C://Users//888//Desktop//王总GIS//地图文件//一分部重点拆迁区域20160625.kml";
		//String	filePath="C://Users//888//Desktop//王总GIS//地图文件//一号线.kml";
	...
	public static void listNodes(Element node) {
		...
		try {
			if ("Placemark".equals(node.getName())) {// 如果当前节点是Placemark就解析其子节点
				...
				heh = new Placemark(coordinateList, name, "Polygon");
				System.out.println("Placemark  Value :" + "name=" + heh.getName() + "type=" + heh.getType() + "points="
						+ heh.getPoints());
				if (coordinateList.size() > 0)
